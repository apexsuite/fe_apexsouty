...
const MarketplaceTable: React.FC<MarketplaceTableProps> = ({
  ...
  const columns: ColumnsType<Marketplace> = [
    ...
    },
    {
      ...
      render: (_, record: Marketplace) => (
        <Space size="small">
          <PermissionGuard permission="get-marketplace" mode="hide">
          ...
          <PermissionGuard permission="update-marketplace" mode="hide">
          ...
          <PermissionGuard permission="delete-marketplace" mode="hide">
  ...
  const MarketplaceCard: React.FC<{ marketplace: Marketplace }> = ({
    marketplace,
  }) => {
              ...
              >
                <div onClick={e => e.stopPropagation()}>
                  <Switch
                    ...
                    onChange={checked =>
                      handleStatusChange(marketplace.id, checked)
                    }
                    size="small"
                  />
                </div>
