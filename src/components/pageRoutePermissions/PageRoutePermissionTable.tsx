...
const PageRoutePermissionTable: React.FC<PageRoutePermissionTableProps> = ({
  ...
  const columns: ColumnsType<Permission> = [
    ...
    },
    {
      ...
      render: (description: string) => (
        <span
          style={{
            color:
              currentTheme === 'dark' ? '#d1d5db' : token.colorTextSecondary,
            fontSize: '14px',
          }}
        >
    ...
    },
    {
      ...
      key: 'label',
      dataIndex: 'label',
      render: (label: string) => <Tag color="cyan">{label || 'No label'}</Tag>,
    },
    {
      title: 'Status',
      key: 'status',
    ...
    },
    {
      ...
      render: (_, record: Permission) => (
        <Space size="small">
          <PermissionGuard permission="get-page-route-permission" mode="hide">
            <Tooltip title="View">
              <Button
                type="text"
                size="small"
  ...
  const PermissionCard: React.FC<{ permission: Permission }> = ({
    permission,
  }) => {
      ...
      >
        <div className="flex items-start justify-between">
          <div className="min-w-0 flex-1">
            ...
            <div className="mb-1 flex items-center gap-2">
              {permission.label && (
                <Tag color="cyan" style={{ fontSize: '10px', marginRight: 0 }}>
                  {permission.label}
                </Tag>
              )}
