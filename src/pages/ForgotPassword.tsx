        ...
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-background">
                <Card className="bg-background text-foreground" style={{ width: '100%', maxWidth: 400, boxShadow: '0 2px 8px #f0f1f2' }}>
                    ...
                    <Typography.Title level={2} className="text-foreground" style={{ textAlign: 'center', marginBottom: 24 }}>{t('forgot.title')}</Typography.Title>
                    <Form layout="vertical" onFinish={handleSubmit} initialValues={{ language: lang }} className="text-foreground">
