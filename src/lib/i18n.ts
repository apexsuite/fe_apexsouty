  ...
  en: {
    translation: {
      ...
      permissions: {
        ...
        enterLabel: 'Enter permission label',
        statusUpdated: 'Permission status updated successfully',
        statusUpdateError: 'Failed to update permission status',
        deletedSuccessfully: 'Permission deleted successfully',
        deleteError: 'Failed to delete permission',
        deletePermission: 'Delete Permission',
        deleteConfirmTitle: 'Are you sure you want to delete this permission?',
        deleteConfirmMessage: 'This action cannot be undone. The permission will be permanently removed from the system.',
        permissionDetails: 'Permission Details',
  ...
  tr: {
    translation: {
      ...
      permissions: {
        ...
        enterLabel: 'İzin etiketini girin',
        statusUpdated: 'İzin durumu başarıyla güncellendi',
        statusUpdateError: 'İzin durumu güncellenemedi',
        deletedSuccessfully: 'İzin başarıyla silindi',
        deleteError: 'İzin silinemedi',
        deletePermission: 'İzni Sil',
        deleteConfirmTitle: 'Bu izni silmek istediğinizden emin misiniz?',
        deleteConfirmMessage: 'Bu işlem geri alınamaz. İzin sistemden kalıcı olarak kaldırılacaktır.',
        permissionDetails: 'İzin Detayları',
        editPermission: 'İzni Düzenle',
        updatePermission: 'İzni Güncelle',
        updatedSuccessfully: 'İzin başarıyla güncellendi',
        updateError: 'İzin güncellenemedi',
      },
      roles: {
        title: 'Roller',
      ...
      product: {
        title: 'Ürünler',
        description: 'Ürünlerinizi ve hizmetlerinizi yönetin',
        create: 'Ürün Oluştur',
        edit: 'Ürünü Düzenle',
