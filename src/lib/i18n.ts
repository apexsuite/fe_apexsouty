  ...
  en: {
    translation: {
      notification: {
        ...
        permissionAssignedSuccessfully: 'Permission assigned successfully!',
        permissionUnassignedSuccessfully: 'Permission unassigned successfully!',
      ...
      pages: {
        ...
        noResults: 'No pages found matching your search criteria',
      ...
      consents: {
        ...
        createDescription: 'Create a new consent with all necessary details',
        editDescription: 'Update consent information and settings',
        ...
        createSuccess: 'Consent created successfully!',
        createError: 'Failed to create consent',
        updateSuccess: 'Consent updated successfully!',
        updateError: 'Failed to update consent',
        deleteSuccess: 'Consent deleted successfully!',
        deleteError: 'Failed to delete consent',
        deleteConfirm: 'Are you sure you want to delete consent "{{name}}"?',
        deleteTitle: 'Delete Consent',
        statusChangeSuccess: 'Consent status changed successfully!',
        statusChangeError: 'Failed to change consent status',
        authorizeSuccess: 'Consent authorized successfully!',
        authorizeError: 'Failed to authorize consent',
        description: 'Manage your consent integrations',
        detailDescription: 'View consent details and information',
        basicInfo: 'Basic Information',
      ...
      billing: {
        ...
        description: 'Manage your billing information and address',
  ...
  tr: {
    translation: {
      notification: {
        ...
        permissionAssignedSuccessfully: 'İzin başarıyla atandı!',
        permissionUnassignedSuccessfully: 'İzin başarıyla kaldırıldı!',
        ...
        consentStatusChangedSuccessfully: 'Onay durumu başarıyla değiştirildi!',
        consentAuthorizedSuccessfully: 'Onay başarıyla yetkilendirildi!',
      ...
      permissions: {
        ...
        permissionsPlaceholder: 'İzin ara...',
      ...
      pages: {
        ...
        active: 'Aktif',
        inactive: 'Pasif',
        searchPlaceholder: 'Sayfaları ara...',
        enterName: 'İsim girin',
        enterPath: 'Path girin',
        enterComponent: 'Component girin',
        selectStatus: 'Durum seçin',
        ...
        pageRoutePermissions: {
          ...
          labelMinLength: 'Etiket en az 2 karakter olmalıdır',
          status: {
            active: 'Aktif',
            inactive: 'Pasif',
          },
          pageRoutePermissionInfo: {
            pageRouteInformation: 'Sayfa Rotası Bilgileri',
            name: 'İsim',
            path: 'Yol',
            component: 'Bileşen',
            icon: 'İkon',
          ...
          pageRouteAssignments: {
            ...
            roleName: 'Rol Adı',
            roleValue: 'Rol Değeri',
            roleStatus: 'Rol Durumu',
            roleDescription: 'Rol Açıklama',
            status: 'Durum',
            status1: {
              active: 'Aktif',
              inactive: 'Pasif',
      ...
      product: {
        title: 'Ürünler',
        description: 'Açıklama',
        enterName: 'Ürün adını girin',
        create: 'Ürün Oluştur',
        edit: 'Ürünü Düzenle',
        filters: 'Filtre',
        enterUnitLabel: 'Birim etiketi girin',
        selectStatus: 'Durum seçin',
      ...
      consents: {
        ...
        create: 'Onay Oluştur',
        edit: 'Onayı Düzenle',
        update: 'Onayı Güncelle',
        createDescription: 'Gerekli tüm detaylarla yeni bir onay oluşturun',
        editDescription: 'Onay bilgilerini ve ayarlarını güncelleyin',
        ...
        createdAt: 'Oluşturulma Tarihi',
        updatedAt: 'Güncellenme Tarihi',
        searchPlaceholder: 'Onay ara...',
        createSuccess: 'Onay başarıyla oluşturuldu!',
        createError: 'Onay oluşturulamadı',
        updateSuccess: 'Onay başarıyla güncellendi!',
        updateError: 'Onay güncellenemedi',
        deleteSuccess: 'Onay başarıyla silindi!',
        deleteError: 'Onay silinemedi',
        deleteConfirm: 'Onay "{{name}}" silmek istediğinizden emin misiniz?',
        deleteTitle: 'Onayı Sil',
        statusChangeSuccess: 'Onay durumu başarıyla değiştirildi!',
        statusChangeError: 'Onay durumu değiştirilemedi',
        authorizeSuccess: 'Onay başarıyla yetkilendirildi!',
        authorizeError: 'Onay yetkilendirilemedi',
        description: 'Onay entegrasyonlarınızı yönetin',
        detailDescription: 'Onay detaylarını ve bilgilerini görüntüleyin',
        basicInfo: 'Temel Bilgiler',
        additionalInfo: 'Ek Bilgiler',
        notFound: 'Onay bulunamadı',
        nameRequired: 'Marketplace adı gerekli',
        nameMinLength: 'Ad en az 2 karakter olmalı',
        nameMaxLength: 'Ad 100 karakteri geçmemeli',
      ...
      billing: {
        ...
        description: 'Fatura bilgilerini ve adres bilgilerini yönetin',
